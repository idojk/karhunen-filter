...
# To be done next: 1.update path after finishing all modules   2. macro split function if we want to use other split.m
...
make_tree<-function(DATA,split_function,params){
  ...
  return(list('tree'=create_tree_out$tree, 'DATA'=DATA))
}
